import { StructuredLogger, generateUuid } from '../src';
...
global.Date.UTC = jest.fn((a, b, c, d, e, f, g) => new Date(Date.UTC(a, b, c, d, e, f, g)).getTime());
...
describe('StructuredLogger', () => {
  ...
  test('should log HTTP responses', () => {
    logger.httpResponse('GET', 'https://example.com/api', 200, { result: 'success' }, {
